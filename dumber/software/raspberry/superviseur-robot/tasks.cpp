...
void Tasks::Init() {
    ...
    if (err = rt_mutex_create(&mutex_askBattery, NULL)) {
        cerr << "Error mutex create: " << strerror(-err) << endl << flush;
        exit(EXIT_FAILURE);
    }  
...
void Tasks::StartRobotTask(void *arg) {
    ...
    while (1) {
        ...
        rt_mutex_release(&mutex_askBattery);
...
/**
 * @brief Get the current level of the robot's battery
 * @param
 * @return
 */
void Tasks::Ask_Battery(void *arg){
    ...
    while (1) {
        ...
        rt_mutex_acquire(&mutex_askBattery, TM_INFINITE);
